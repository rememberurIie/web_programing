...
<body>
    ...
    <form action="register_db.php" method="post" class="login-form">
        <div>
            <label for="first_name"><b>Firstname</b></label>
            <input type="text" placeholder="Type Firstname" name="first_name">

            <label for="last_name"><b>Lastname</b></label>
            <input type="text" placeholder="Type Lastname" name="last_name">

            <label for="email"><b>Email</b></label>
            <input type="email" placeholder="Type Email" name="email">

            <label for="phone"><b>Phone</b></label>
            <input type="text" placeholder="Type Phone Number" name="phone">
            ...
            <span class="already_member">Already a member? <a href="login.php">Sign in.</a></span>
